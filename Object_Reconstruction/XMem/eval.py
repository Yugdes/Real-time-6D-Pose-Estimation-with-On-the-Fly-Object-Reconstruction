...
# annotations_dir = 'input/Annotations/video1'
# scores_dir = 'input/Scores/video1'

# # Delete all predicted masks except the initial one
# for f in os.listdir(annotations_dir):
#     if f != '00000000.png':
#         os.remove(os.path.join(annotations_dir, f))

# # Optionally clear scores if saved
...
parser.add_argument('--model', default='/home/iitgn-robotics-2/yug_ws/Object_Reconstruction/BundleSDF/BundleTrack/XMem/saves/XMem-s012.pth')
...
# Load object_name from file
with open("../last_object_name.txt", "r") as f:
    object_name = f.read().strip()
args.generic_path = os.path.join('../input', object_name)
args.output = os.path.join('../input', object_name)
config = vars(args)
