...
parser.add_argument('--mesh_file', type=str, default='/home/iitgn-robotics-2/yug_ws/Object_Reconstruction/mesh/mesh_cleaned.obj')
...
mesh = trimesh.load(args.mesh_file).apply_scale(0.06)
